...
class GraphGPT_pl(LightningModule): 
    ...
    ## load 4 8 bit 
        ...
        # 配置图网络路径，避免 “…clip_gt_arxivclip_gt_arxiv” 重复拼接
        if model_args.graph_tower:
            base_path = getattr(self.model.config, "pretrain_graph_model_path", "") or ""
            ...
            self.model.config.pretrain_graph_model_path = new_graph_path

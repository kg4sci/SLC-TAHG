...
conv_graphchat_v1 = Conversation(
    ...
    system="You are able to understand the graph structures that the user provides, and assist the user with a variety of tasks using natural language."
           "Follow the instructions carefully and explain your answers in detail.\n"
           "Important: You need to perform cascading predictions for the relationships rel_AB and rel_BC between entities A, B, and C.The relationship type must be one of: PROMOTION or SUPPRESSION.\n"
